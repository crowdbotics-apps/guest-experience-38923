...
## Project Structure
    ...
    ├── guest_experience_38923  # Django project configurations
...
1. Clone this repo and `cd guest_experience_38923`
...
2. Clone this repo and `cd guest_experience_38923`
